...
// Replace AdminNavbar with ProfessorNavbar
...
export default function ResearcherHomePage() {
  ...
  // Remove appointments from activeView type, only keep management
  const [activeView, setActiveView] = React.useState<'management'>('management');
  ...
  const handleAssessment = (id: number, name: string, type: string) => {
    // Empty function - does nothing for researcher view
  };
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 py-8">
        {/* Only show management view, remove appointments entirely */}
        <div>
          <AdminManagement
            ...
            detailRoute="/researcher-detail-researcher" // Add this prop
          />
        </div>
      </div>
    </ProfessorNavbar>
