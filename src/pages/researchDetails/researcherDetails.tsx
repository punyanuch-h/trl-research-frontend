    ...
    return (
        <div className="space-y-6 text-gray-600">
            <div className="space-y-4">
                ...
                <div>
                    <Label htmlFor="headDepartment">ภาควิชา / สถาน / หน่วยงาน ของหัวหน้าโครงการ*</Label>
                    <p className="text-xs text-muted-foreground mb-1">(รวมหน่วยงานที่เทียบเท่าภาควิชา)</p>
                    <Input
                        id="headDepartment"
            ...
            <div className="space-y-4">
                ...
                {formData.isUrgent && (
                    <div>
                        <Label htmlFor="urgentReason">เหตุผลความเร่งด่วน <span className="text-red-500">*</span></Label>
                        <Textarea
                            id="urgentReason"
